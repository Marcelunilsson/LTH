...
rewards   = struct('default', -.01, 'apple', 10, 'death', -100); % Experiment with different reward signals, to see which yield a good behaviour for the agent
gamm      = 0.95;                                          % Discount factor in Q-learning
alph      = .1;                                           % Learning rate in Q-learning
