...
public class Golomb {
	...
	SplitSearchLower search = new SplitSearchLower(store);
	//SplitSearchLowerVarChoice search = new SplitSearchLowerVarChoice(store);
	//SplitSearchUpper search = new SplitSearchUpper(store);
	//SplitSearchUpperVarChoice search = new SplitSearchUpperVarChoice(store);
	...
	System.out.println("Total number of visited nodes = " + search.visitedNodes);
